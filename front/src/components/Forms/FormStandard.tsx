                            ...
                            <fieldset>
                                ...
                                <FormGroup row>
                                    ...
                                    <div className="col-md-10">
                                        ...
                                        <div className="checkbox c-checkbox">
                                            <label>
                                                <Input type="checkbox" defaultChecked={true} defaultValue=""/>
                                                <span className="fa fa-check"></span>Option two defaultChecke</label>
                                        </div>
                                        <div className="checkbox c-checkbox">
                                            <label>
                                                <Input type="checkbox" defaultChecked={true} disabled defaultValue=""/>
                                        ...
                                        <div className="c-radio">
                                            <label>
                                                <Input type="radio" name="a" defaultValue="option2" defaultChecked={true}/>
                                                <span className="fa fa-circle"></span>Option two defaultChecke</label>
                                        </div>
                                        <div className="c-radio">
                                            <label>
                                                <Input type="radio" defaultValue="option2" defaultChecked={true} disabled/>
